...
software:
  1. main.c: Actúa como el administrador central. Inicializa los recursos, pregunta al usuario el tamaño del estacionamiento, inicializa
  los threads y al final limpia la memoria.
  2. parking.c / .h: Contiene el "cerebro" o ciclo de vida del auto (Llegar, Esperar en el semáforo,
  Estacionarse y Salir).
  3. Puntos Extra (Dashboard): Se implementó un hilo monitor adicional que limpia la terminal y dibuja en tiempo real una
